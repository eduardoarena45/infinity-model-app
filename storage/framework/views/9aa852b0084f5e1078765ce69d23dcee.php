...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-1 transition-all duration-300
    <?php if($isDestaque): ?> border-2 border-yellow-400 <?php endif; ?>">
    <a href="<?php echo e(route('vitrine.show', $perfil->id)); ?>" class="block">
        <div class="relative">
            
            <img src="<?php echo e($perfil->foto_principal_url); ?>" alt="Foto de <?php echo e($perfil->nome_artistico); ?>" class="w-full h-48 sm:h-64 object-cover">
        ...
        <div class="p-2 sm:p-3">
            ...
            <h3 class="text-sm sm:text-base font-semibold text-[--color-primary] dark:text-white truncate"><?php echo e($perfil->nome_artistico); ?></h3>
            <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 truncate"><?php echo e($perfil->cidade->nome ?? 'Cidade'); ?></p>
            ...
            <p class="text-base sm:text-lg font-bold text-green-600 dark:text-green-400 mt-2">
                R$ <?php echo e(number_format($perfil->valor_hora, 0, ',', '.')); ?> 
                <span class="text-xs font-normal text-gray-500">/ hora</span>
            </p>
        </div>
    </a>
</div><?php /**PATH C:\laragon\www\infinity_model_app\resources\views/partials/acompanhante-card.blade.php ENDPATH**/ ?>