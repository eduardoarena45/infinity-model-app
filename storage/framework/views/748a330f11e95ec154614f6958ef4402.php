        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100 text-center">
                    ...
                    <h3 class="text-2xl font-bold text-[--color-primary] dark:text-cyan-400">Quase lá!</h3>
                    ...
                    <div class="mt-6 border-t border-b dark:border-gray-700 py-4">
                        <p class="text-lg">Você escolheu: <span class="font-bold"><?php echo e($assinatura->plano->nome); ?></span></p>
                        <p class="text-3xl font-extrabold my-2">Valor: R$ <?php echo e(number_format($assinatura->plano->preco, 2, ',', '.')); ?></p>
                    </div>

                    <div class="mt-6">
                        <h4 class="font-bold text-lg mb-4">Pague com PIX</h4>
                        
                        <div class="flex justify-center">
                            
                            <img src="<?php echo e(asset('images/meu-qrcode-pix.png')); ?>" alt="QR Code PIX" class="w-48 h-48 border dark:border-gray-600 p-2 rounded-lg">
                        </div>
                    ...
                    <div class="mt-8 p-4 bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-300 rounded-lg text-left">
                        ...
                        <ol class="list-decimal list-inside mt-2 text-sm space-y-1">
                            ...
                            <li>Após o pagamento, clique no botão abaixo para **enviar o comprovativo** para o nosso WhatsApp de suporte.</li>
                    ...
                    <div class="mt-6">
                        ...
                        ?>
                        <a href="<?php echo e($linkWhatsapp); ?>" target="_blank" class="w-full flex items-center justify-center bg-green-500 text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-green-600 transition-colors shadow-lg">
                    ...
                    <div class="mt-8">
                        <a href="<?php echo e(route('dashboard')); ?>" class="text-sm text-gray-500 hover:underline">Voltar para o Painel</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\infinity_model_app\resources\views/planos/pagamento.blade.php ENDPATH**/ ?>