...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'Infinity Model'); ?></title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('cidades.index')); ?>" class="flex items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-[--color-accent] transition-colors">Meu Painel</a>
                            <form method="POST" action="<?php echo e(route('logout')); ?>">
                                <?php echo csrf_field(); ?>
                                <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); this.closest('form').submit();" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-[--color-accent] transition-colors">Sair</a>
                            </form>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-[--color-accent] transition-colors">Login</a>
                            <?php if(Route::has('register')): ?>
                                
                                <a href="<?php echo e(route('register')); ?>" class="ml-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-opacity">
                                    Cadastrar
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
        ...
        <footer class="bg-white dark:bg-gray-800 mt-16">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div class="flex justify-center space-x-6">
                    <a href="<?php echo e(route('termos')); ?>" class="text-sm text-gray-500 hover:text-gray-900 dark:hover:text-white">Termos de Serviço</a>
                    <a href="<?php echo e(route('privacidade')); ?>" class="text-sm text-gray-500 hover:text-gray-900 dark:hover:text-white">Política de Privacidade</a>
                </div>
                <div class="mt-8 text-center">
                    <p class="text-center text-base text-gray-400">&copy; <?php echo e(date('Y')); ?> Infinity Model. Todos os direitos reservados.</p>
                </div>
            </div>
        </footer>
...
<?php /**PATH C:\laragon\www\infinity_model_app\resources\views/layouts/public.blade.php ENDPATH**/ ?>